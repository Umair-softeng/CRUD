                        ...
                        <form class="dt_adv_search" method="POST">
                            <div class="row g-1 mb-md-1">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                                    ...
                                    <input type="text" class="form-control dt-input dt-full-name" data-column="0" placeholder="Search By Product ID" data-column-index="0">
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                                    ...
                                    <input type="text" class="form-control dt-input" data-column="2" placeholder="Search By Category Name" data-column-index="2">
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        if (exist) {
            if(msg === "Product Added Successfully!!"){
                toastr.success(msg);
            }else if(msg === "Product Deleted Successfully!!"){
                toastr.error(msg);
            }else if(msg === "Product Updated Successfully!!"){
                toastr.info(msg);
            }
        }
        ...
        $(function () {
            ...
            if (category.length) {
                category.DataTable({
                    ajax: "{{route('product.index')}}", // JSON file to add data
                    autoWidth: false,
                    columns: [
