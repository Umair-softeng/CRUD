            ...
            <section class="invoice-list-wrapper">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title">Categories Search</h4>
                    </div>
                        ...
                        <form class="dt_adv_search" method="POST">
                            <div class="row g-1 mb-md-1">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                                    ...
                                    <input type="text" class="form-control dt-input dt-full-name" data-column="0" placeholder="Search By Category ID" data-column-index="0">
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                                    <label class="form-label">Category Name:</label>
                                    <input type="text" class="form-control dt-input" data-column="1" placeholder="Search By Category Name" data-column-index="1">
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        if (exist) {
            if(msg === "Category Added Successfully!!"){
                ...
                toastr.error(msg);
            }else if(msg === "Category Updated Successfully!!"){
                toastr.info(msg);
            }
        }
